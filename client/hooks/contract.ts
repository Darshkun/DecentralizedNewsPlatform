...
export const CONTRACT_ADDRESS =
  "CDSRLP4MG5T7EKWHJBIMYDANEXKLMZFIHPXEZURXLHCV7JUX6EWM62OH";
...
// ============================================================
// Decentralized News Platform — Contract Methods
// ============================================================

/**
 * Publish a news article to the blockchain.
 * Calls: publish_news(author: Address, content: String) -> u32
 * Returns: The news ID
 */
 ...
 * Calls: get_news(news_id: u32) -> (Address, String)
 * Returns: { 0: author_address, 1: content } or null
 */
 ...
 * Calls: total_news() -> u32
 * Returns: Total count
 */
export async function totalNews(caller?: string) {
  return readContract(
    "total_news",
    [],
    caller
